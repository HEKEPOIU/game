...
stream_flags :: bit_set[stream_flag;i32]
...
metadata_events :: struct {
    version:  u32,
    property: proc "c" (data: rawptr, subject: u32, key, type, value: cstring) -> c.int,
}
...
Module_Change_Mask_Set :: bit_set[Module_Change_Mask;u64]
Module_Change_Mask :: enum {
    PROPS = 1 << 0,
}
MODULE_CHANGE_MASK_ALL :: Module_Change_Mask_Set{.PROPS}

Core_Change_Mask_Set :: bit_set[Core_Change_Mask;u64]
Core_Change_Mask :: enum {
    PROPS = 1 << 0,
}

Core_Change_Mask_ALL :: Core_Change_Mask_Set{.PROPS}
...
stream_control :: struct {
    name:       cstring, /**< name of the control */
    flags:      u32, /**< extra flags (unused) */
    def:        f32, /**< default value */
    min:        f32, /**< min value */
    max:        f32, /**< max value */
    values:     ^f32, /**< array of values */
    n_values:   u32, /**< number of values in array */
    max_values: u32, /**< max values that can be set on this control */
}
buffer :: struct {
    buffer:    ^spa_buffer, /**< the spa buffer */
    user_data: rawptr, /**< user data attached to the buffer. The user of
    ...
    size:      u64, /**< This field is set by the user and the sum of
    ...
    requested: u64, /**< For playback streams, this field contains the
    ...
    time:      u64, /**< For capture streams, this field contains the
...
stream_events :: struct {
    version:       u32,
    destroy:       proc "c" (data: rawptr),
    /** when the stream state changes. Since 1.4 this also sets errno when the
	 * new state is PW_STREAM_STATE_ERROR */
    state_changed: proc "c" (data: rawptr, old: stream_state, state: stream_state, error: cstring),

    /** Notify information about a control.  */
    control_info:  proc "c" (data: rawptr, id: u32, control: ^stream_control),

    /** when io changed on the stream. */
    io_changed:    proc "c" (data: rawptr, id: u32, area: rawptr, size: u32),
    /** when a parameter changed */
    param_changed: proc "c" (data: rawptr, id: u32, param: ^spa_pod),

    /** when a new buffer was created for this stream */
    add_buffer:    proc "c" (data: rawptr, buffer: ^buffer),
    /** when a buffer was destroyed for this stream */
    remove_buffer: proc "c" (data: rawptr, buffer: ^buffer),
    ...
    process:       proc "c" (data: rawptr),

    /** The stream is drained */
    drained:       proc "c" (data: rawptr),

    /** A command notify, Since 0.3.39:1 */
    command:       proc "c" (data: rawptr, command: ^spa_command),
	 ...
	 *  thread if the user is prepared to deal with this. */
    trigger_done:  proc "c" (data: rawptr),
}
...
Link_Change_Mask_Set :: bit_set[Link_Change_Mask;u64]
...
Link_Change_Mask_ALL :: Link_Change_Mask_Set{.STATE, .FORMAT, .PROPS}
